...
const mockEvents: Partial<Event>[] = [
	{
		id: 1,
		title: 'Event One',
		images: [{ path: 'path/to/image1.jpg', name: 'Image 1' }],
	...
	},
	{
		id: 2,
		title: 'Event Two',
		images: [{ path: 'path/to/image2.jpg', name: 'Image 2' }],
...
describe('EventList component', () => {
	...
	it('renders EventCard with correct props', () => {
		...
		mockEvents.forEach(event => {
			...
			if(event.images) {
				expect(screen.getByAltText(event.images[0].name)).toHaveAttribute('src', event.images[0].path);
			}
